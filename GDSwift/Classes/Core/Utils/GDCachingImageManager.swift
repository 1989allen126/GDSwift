...
public class GDCachingImageManager: PHCachingImageManager {
   
    public override class func `default`() -> GDCachingImageManager {
        return super.default() as! GDCachingImageManager
    }
...
//        option.deliveryMode = .fastFormat
    ...
    class func readCacheFromUrl(url: String) -> Data? {
        var data: Data?
        let path: String = GDCachingImageManager.getFullCachePathFromUrl(url: url)
    ...
    class func getFullCachePathFromUrl(url: String) -> String {
        ...
        //进行字符串处理
        var newURL: String
        newURL = GDCachingImageManager.stringToString(str: url)
