...
class GDProgressView: UIView {
    ...
    static func showGDProgressView(in parentView: UIView, frame: CGRect) -> GDProgressView {
        
        var progressView = parentView.viewWithTag(9999) as? GDProgressView
        
        guard (progressView != nil) else {
            progressView = GDProgressView(frame: frame)
